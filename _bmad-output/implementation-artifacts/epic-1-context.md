...
- **Deferred (do not build):** presigned-URL ingest, FAILED-producing path, real ffmpeg, single-table DynamoDB, event-schema versioning policy, SQS DLQ/retry, ingest-leg reconciliation, real AWS, CI/CD, remote state.
