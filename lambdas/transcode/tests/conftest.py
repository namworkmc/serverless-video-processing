"""Test harness for the transcode Lambda (Story 2.1, ATDD).

- Adds `lambdas/` to sys.path so `import transcode` resolves to
  `lambdas/transcode/` (in the Lambda zip the package sits at the zip
