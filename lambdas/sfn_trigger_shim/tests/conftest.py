"""Test harness for the sfn-trigger-shim Lambda (Story 2.3, ATDD).

- Adds `lambdas/` to sys.path so `import sfn_trigger_shim` resolves to
  `lambdas/sfn_trigger_shim/` (in the Lambda zip the package sits at the zip
