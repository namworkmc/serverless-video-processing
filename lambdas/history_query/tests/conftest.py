"""Test harness for the history-query Lambda (Story 3.2, ATDD).

- Adds `lambdas/` to sys.path so `import history_query` resolves to
  `lambdas/history_query/` (in the Lambda zip the package sits at the zip
