"""Test harness for the search-query Lambda (Story 4.2, ATDD).

- Adds `lambdas/` to sys.path so `import search_query` resolves to
  `lambdas/search_query/` (in the Lambda zip the package sits at the zip
