"""Test harness for the event-publisher Lambda (Story 2.2, ATDD).

- Adds `lambdas/` to sys.path so `import event_publisher` resolves to
  `lambdas/event_publisher/` (in the Lambda zip the package sits at the zip
