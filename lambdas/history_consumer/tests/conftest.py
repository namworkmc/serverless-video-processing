"""Test harness for the history-consumer Lambda (Story 3.1, ATDD).

- Adds `lambdas/` to sys.path so `import history_consumer` resolves to
  `lambdas/history_consumer/` (in the Lambda zip the package sits at the zip
