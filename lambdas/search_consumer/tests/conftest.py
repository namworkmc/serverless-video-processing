"""Test harness for the search-consumer Lambda (Story 4.1, ATDD).

- Adds `lambdas/` to sys.path so `import search_consumer` resolves to
  `lambdas/search_consumer/` (in the Lambda zip the package sits at the zip
